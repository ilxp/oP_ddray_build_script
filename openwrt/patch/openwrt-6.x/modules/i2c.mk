...
define KernelPackage/i2c-i801
  ...
  DEPENDS:=@PCI_SUPPORT @TARGET_x86 +kmod-i2c-core +kmod-i2c-smbus +(LINUX_6_12||LINUX_6_13):kmod-i2c-mux
endef
...
define KernelPackage/i2c-piix4
  ...
  DEPENDS:=@PCI_SUPPORT @TARGET_x86 +kmod-i2c-core +(LINUX_6_12||LINUX_6_13):kmod-i2c-smbus
endef

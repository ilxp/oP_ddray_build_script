...
##curl -s $mirror/tags/kernel-6.13 > kernel.txt  #有时获取不到
#wget -qO- "$mirror/tags/kernel-6.13"  >> kernel.txt
...
EOF
	...
	# 重命名固件 格式：OprX-openwrt-x86_64-oP-R24.9.18-2024091815-Fsquashfs-uefi-c347f.img.gz
